...
* **Very fast**: [FlintParser](docs/FlintParser.md) implements a novel, very efficient approach to NLU (Natural Language Understanding) that beats many alternatives in production today, without using any embedding or machine-learning techniques.
* **Fast development**: craft datasets with ease thanks to [NDF 0.0 (NPC-Forge Dataset Format)](docs/dataset.md).
