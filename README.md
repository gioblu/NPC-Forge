...
* **Very fast**: [FlintParser](docs/FlintParser.md) and [FlintNPC](docs/FlintNPC.md) implement a novel, very efficient approach to NLU (Natural Language Understanding).
