...
* **Very fast**: [FlintParser](docs/FlintParser.md) implements a novel, very efficient approach to NLU (Natural Language Understanding) that beats many alternatives in production today.
* **Fast development**: craft datasets with ease thanks to the [NDF 0.0 (NPC-Forge Dataset Format)](docs/dataset.md) specification.
